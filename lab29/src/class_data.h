...
class Dessert {
	...
	{
		// ѕоскольку operator<< €вл€етс€ другом класса Point, то мы имеем пр€мой доступ к членам Point
...
public:
	...
	Dessert(bool glucose, std::string name, double weight, double nkkal, double nproteins, double nfats, double ncarb, std::string taste);
