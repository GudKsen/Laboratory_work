...
int main(){
    ...
    number_into_words(NUMBER, RES, result);
return 0;
}

void number_into_words(int number, int res, char result[]) {
    #define STR 4
    #define COL 15
    #define TH 15
    #define HN 14
    ...
    #define TEN 10
    #define SN 5
    #define STR_NUMBERS 9
    char arr[STR][COL];
    int a = TH, b = HN, c = DEC, d = TEN, e = SN; 
    
    char thousand[STR_NUMBERS][TH] = {{'O','n','e',' ','t','h','o','u','s','a','n','d'},
    ...
    char hundred[STR_NUMBERS][HN] = {{'O','n','e',' ','h','u','n','d','r','e','d'},
                        {'T','w','o',' ','h','u','n','d','r','e','d'},
    ...
    char dec[STR_NUMBERS][DEC] = {{'t','w','e','n','t','y'},
                    {'t','h','i','r','t','y'},
                    {'f','o','u','r','t','y'},
                    {'f','i','f','t','y'},
                    {'s','i','x','t','y'},
                    ...
                    {'e','i','g','h','t','y'},
                    {'n','i','n','e','t','y'}};
    char ten[STR_NUMBERS][TEN] = {{'t','e','n'},
                    {'e','l','e','v','e','n'},
                    {'t','w','e','l','v','e'},
                    {'t','h','i','r','t','e','e','n'},
                    {'f','o','u','r','t','e','e','n'},
                    ...
                    {'e','i','g','h','t','e','e','n'},
                    {'n','i','n','e','t','e','e','n'}};
    char single[STR_NUMBERS][SN] = {{'o','n','e'},
                       {'t','w','o'},
                       {'t','h','r','e','e'},
                       {'f','o','u','r'},
                       {'f','i','v','e'},
    ...
    int k = 0;
   for(int i = 0; i < STR; i++){                    //результуючий масив
       for(int j = 0; j < COL; j++){
           result[k] = arr[i][j];
           k++;
       }
